                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-2 p-2 border rounded bg-light">
                            ...
                            <a href="{{ Storage::disk('public')->url($leaveRequest->document) }}"
                               target="_blank" class="text-primary text-decoration-none fw-semibold small">
                                {{ basename($leaveRequest->document) }}
                            </a>
                            <span class="ms-auto">
                                <label class="form-check-label small text-danger d-flex align-items-center gap-1 mb-0" style="cursor:pointer">
                                    <input type="checkbox" name="remove_document" value="1" class="form-check-input mt-0">
                                    Remove file
                                </label>
                            </span>
                        </div>
                        ...
                        <div class="form-text">
                            ...
                            Accepted: PDF, JPG, PNG, DOC, DOCX &nbsp;·&nbsp; Max size: 5 MB
                        </div>
