...
<div class="auth-card">
    <div class="auth-header">
        @php
            $loginLogoUrl = \Illuminate\Support\Facades\Cache::remember('app_favicon_url', 3600, function () {
        ...
        @endphp
        <div class="auth-logo" style="{{ $loginLogoUrl ? 'background:transparent;padding:0;width:54px;height:54px;' : '' }}">
            @if($loginLogoUrl)
    ...
    <div class="auth-body">
        <h5 class="fw-semibold mb-1" style="font-size:15px">Sign in to your account</h5>
        <p class="mb-3" style="font-size:12px;color:var(--md-text-muted)">Enter your credentials to continue</p>
        ...
        <p class="text-center mt-3 mb-0" style="font-size:11px;color:var(--md-text-muted)">
