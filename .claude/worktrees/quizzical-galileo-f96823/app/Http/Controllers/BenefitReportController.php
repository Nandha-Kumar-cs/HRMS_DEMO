...
class BenefitReportController extends Controller
{
    ...
    public function monthlyBenefits(Request $request)
    {
        ...
        $query = EmployeeBenefit::with(['employee.department', 'fundType'])
        ...
        $rows = $query->get()->groupBy('benefit_fund_type_id');
        ...
        return view('reports.monthly-benefits', compact(
            'summary', 'month', 'year', 'search', 'department', 'departments'
        ));
    }
