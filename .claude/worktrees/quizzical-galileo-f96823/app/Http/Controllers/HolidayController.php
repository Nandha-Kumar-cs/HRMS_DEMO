...
class HolidayController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('holidays.index', compact('holidays', 'allDays', 'year', 'types', 'availedHolidayDates'));
    }
    ...
    public function toggleWorkingDay(Holiday $holiday)
    {
        $isNowWorking = !$holiday->is_working_day;
        $holiday->update(['is_working_day' => $isNowWorking]);
