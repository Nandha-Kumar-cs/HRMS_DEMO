...
class Employee extends Model
{
    ...
    {
        // Exclude completed loans — they should never appear in payroll again
        return $this->hasMany(EmployeeLoan::class)->whereIn('status', ['active', 'closed']);
    }
    ...
    {
        return $this->hasOne(\App\Models\EmployeeBankDetail::class);
    }
