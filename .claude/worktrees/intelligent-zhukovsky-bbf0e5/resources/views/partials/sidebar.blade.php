<nav id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        @php $payActive = request()->routeIs('salary-slips.*','loans.*','increments.*','promotions.*','attendance.*','leave-requests.*','holidays.*','employee-benefits.*','employee-bonuses.*'); @endphp
        <li>
        ...
        {{-- ── ATTENDANCE ──────────────────────────────── --}}
        @php $attActive = request()->routeIs('attendance.*','leave-requests.*','leave-types.*','holidays.*'); @endphp
        <li>
        ...
        @php $settActive = request()->routeIs('salary-components.*','departments.*','designations.*','entities.*','leave-types.*','users.*','holiday-types.*','benefit-fund-types.*','roles.*','permissions.*','mobile-access.*'); @endphp
        <li>
