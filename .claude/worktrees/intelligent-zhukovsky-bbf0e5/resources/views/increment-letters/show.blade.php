...
<div class="card page-card" id="printArea">
    <div class="card-body p-5">
        <div class="d-flex justify-content-between align-items-start mb-5">
            <div>
                <h2 class="fw-bold text-primary mb-0">HRMS</h2>
                <div class="text-muted small">Human Resource Management System</div>
                <div class="small">123 Business Park, Tech City, India — 400001</div>
            </div>
            <div class="text-end">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-5 ms-auto"><div class="border-top pt-2"><div class="text-muted small">Authorized Signatory</div><div class="fw-semibold">HR Department</div></div></div>
        </div>
    </div>
</div>
@endsection
