        ...
        <form action="{{ route('employee-benefits.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="month" name="effective_month" value="{{ old('effective_month', now()->format('Y-m')) }}" class="form-control" required>
                    <div class="form-text">Will be applied from this month onwards.</div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" rows="2" class="form-control" maxlength="1000">{{ old('description') }}</textarea>
                </div>
            </div>
