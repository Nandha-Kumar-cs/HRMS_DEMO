...
class AttendanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'attendance.*' => 'required|in:present,absent,half_day,late,on_leave',
        ]);
        ...
        foreach ($request->attendance as $employeeId => $status) {
            ...
            // 09:00 + 2:00 = 11:00. Only applies when not already absent/on_leave.
            if (!in_array($status, ['absent', 'on_leave']) && !empty($checkIn)) {
                try {
    ...
    public function report(Request $request)
    {
        ...
        foreach ($employees as $emp) {
            ...
            foreach ($empRecs as $rec) {
                ...
                // on_leave = not absent/late/half-day
        ...
        return view('attendance.report', compact(
            ...
            'nonWorkingDays', 'totalWorkingDays', 'empStats', 'lateByDay'
        ));
    }
