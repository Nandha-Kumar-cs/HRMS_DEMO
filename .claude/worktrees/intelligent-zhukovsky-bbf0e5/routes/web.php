...
Route::middleware('admin.auth')->group(function () {
    ...
    // ── Company Assets ────────────────────────────────────────────────────
    Route::resource('assets', CompanyAssetController::class)->except(['show']);
    Route::get('assets/{asset}/assign',  [CompanyAssetController::class, 'assign'])->name('assets.assign');
    Route::post('assets/{asset}/assign', [CompanyAssetController::class, 'storeAssignment'])->name('assets.assign.store');
    Route::get('assets/{asset}/return',  [CompanyAssetController::class, 'returnForm'])->name('assets.return-form');
    Route::post('assets/{asset}/return', [CompanyAssetController::class, 'processReturn'])->name('assets.return');
