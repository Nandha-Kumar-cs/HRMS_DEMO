...
<div class="card page-card">
    ...
    <div class="card-body">
        ...
        <div class="d-flex gap-3 mb-2 flex-wrap align-items-center">
            ...
            <span class="ms-2 badge" style="background:#0891b2;font-size:.7rem">OD</span>
                    ...
                    <tr>
                        ...
                        @for($d = 1; $d <= $days; $d++)
                            ...
                            <td class="text-center {{ $isNonWrk ? 'table-secondary text-muted' : '' }}"
                                style="{{ $isCompOffDay && !$isNonWrk ? 'background:#ede9fe;' : ($isOnDuty ? 'background:#ecfeff;' : '') }}">
                                @if($isNonWrk)
                                ...
                                @elseif($isOnDuty)
                                    <span class="badge" style="background:#0891b2;font-size:.68rem"
