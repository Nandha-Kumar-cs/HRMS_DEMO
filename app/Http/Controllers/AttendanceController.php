...
class AttendanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Load holiday with type for the modal (separate from nonWorkingLabel check above)
        $holidayRecord = \App\Models\Holiday::with('holidayType')
            ->where('date', $date)->first();

        return view('attendance.index', compact(
            'date', 'prevDate', 'employees', 'attendanceMap', 'isNonWorking', 'nonWorkingLabel', 'holidayRecord'
        ));
    }
